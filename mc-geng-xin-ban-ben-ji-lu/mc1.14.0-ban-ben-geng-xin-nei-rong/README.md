...
<mark style="color:blue;">**MC1.14.0.1补丁MC1.14.0.1补丁**</mark>#### 【更新】1.14.0.1版本补丁更新公告：BC1.14.0.1

更新补丁版本：1.14.0.1\
更新时间：2024-2-28\
更新内容：

<mark style="color:blue;">**MC1.14.0.1补丁**</mark>
...
* 修复了若干可能发生在游戏过程中的崩溃。
* 修复了若干可能发生在PlayStation 4版游戏存档转换过程中的崩溃（[MCPE-58594](https://bugs.mojang.com/browse/MCPE-58594)）。
* 修复了登录微软账户时可能发生的崩溃。
* 修复了在试玩版本中解锁奖杯时出现的崩溃。
* 游玩其他版本的存档时不再拖长加载时间。
...
* 当玩家朝向南或北时，视觉摇晃会正确运作。（[MCPE-56214](https://bugs.mojang.com/browse/MCPE-56214)）。
* 转换PlayStation 4版的存档不再导致[潜影盒](https://zh.minecraft.wiki/w/%E6%BD%9C%E5%BD%B1%E7%9B%92)储存的物品消失（[MCPE-58465](https://bugs.mojang.com/browse/MCPE-58465)）。
* 修复了转换PlayStation 4版的存档会导致作弊开启的漏洞（[MCPE-58499](https://bugs.mojang.com/browse/MCPE-58499)）。
* 修复了多人游戏下一些奖杯会为全体玩家解锁的漏洞。

生物

* [蜜蜂](https://zh.minecraft.wiki/w/%E8%9C%9C%E8%9C%82)现在会在进行攻击后死亡（[MCPE-53860](https://bugs.mojang.com/browse/MCPE-53860)）。
...
[蜜脾](https://zh.minecraft.wiki/w/%E8%9C%9C%E8%84%BE)
...
[黏液块](https://zh.minecraft.wiki/w/%E9%BB%8F%E6%B6%B2%E5%9D%97)
